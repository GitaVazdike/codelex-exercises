...
public class Exercise5 {
    ...
    public static <T> double partOf(List<T> listTitle, Predicate<T> criterion) {
        long matchCount = listTitle.stream().filter(criterion).count();
        return (double) matchCount / listTitle.size();
    }
}
