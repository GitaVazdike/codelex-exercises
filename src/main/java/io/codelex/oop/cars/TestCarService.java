...
public class TestCarService {
    public static void main(String[] args) {
        ...
        Car fordMustang = new Car("Ford", "Mustang GT Fastback", 40000D, 2021, EngineType.V8,
                new Manufacturer("Ford Motor Company", 1903, "USA"));
        ...
        Car toyota = new Car("Toyota", "Century", 10500D, 1998, EngineType.V12,
                new Manufacturer("Toyota Motor Corporation", 1937, "Japan"));
        ...
        Car bmw = new Car("BMW", "118", 4000D, 2005, EngineType.S6,
                new Manufacturer("BMW Group", 1916, "Germany"));
        Car audi = new Car("Audi", "S3", 4500D, 1999, EngineType.S3,
                new Manufacturer("Volkswagen Group", 1937, "Germany"));
        Car lexus = new Car("Lexus", "LS 460", 10000D, 2008, EngineType.V8,
                new Manufacturer("Toyota Motor Corporation", 1937, "Japan"));
